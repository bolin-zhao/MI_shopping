...
public class EmailUtils {
    ...
    public static void sendEmail(User user){
        //发送方
        String myAccount = "15538138427@163.com";
        //授权码
        String myPass = "ZBL2915149549";
        //发件人 邮箱的 SMTP 服务器地址
    ...
    private static MimeMessage createMsg(Session session, String myAccount, User user) {
        ...
        try {
            ...
            message.setContent(user.getUsername()+",你好<br>欢迎注册小米商城! 请点击链接进行激活:<a href='"+url+"'>点击此处激活</a>","text/html;charset=utf-8");
            //设置邮件的发送时间 是立即发送
